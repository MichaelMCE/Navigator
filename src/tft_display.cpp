...
//#if USE_EXTMEM_BUFFER
	...
	//CCM_CBCMR |= (CCM_CBCMR_FLEXSPI2_PODF(5) | CCM_CBCMR_FLEXSPI2_CLK_SEL(3));		// 88.0 MHz
	...
	//CCM_CBCMR |= (CCM_CBCMR_FLEXSPI2_PODF(3) | CCM_CBCMR_FLEXSPI2_CLK_SEL(2));		// 166.2 MHz
	  CCM_CBCMR |= (CCM_CBCMR_FLEXSPI2_PODF(4) | CCM_CBCMR_FLEXSPI2_CLK_SEL(1));		// 144.0 MHz
...
/*
CCM_CBCMR_FLEXSPI2_CLK_SEL
0 = 396 MHz
1 = 720 MHz
2 = 664.62 MHz
3 = 528 MHz

CCM_CBCMR_FLEXSPI2_PODF
divisor + 1
 ...
 CCM_CBCMR_FLEXSPI2_PODF(3) | CCM_CBCMR_FLEXSPI2_CLK_SEL(1); // 180.0 MHz
*/
...
{
	backLightLevel = level&0xFF;
	display_setBacklight(backLightLevel);
}
